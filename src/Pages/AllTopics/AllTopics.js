    ...
    <div>
      <div className="d-flex align-items-center mb-2 w-80 justify-content-center">
        ...
        <Pdf targetRef={ref} filename="code-example.pdf">
          {({ toPdf }) => (
            <Button onClick={toPdf} className="ms-5" variant="outline-primary">
              <FaFileDownload></FaFileDownload> Download
            </Button>
          )}
        </Pdf>
      </div>
      ...
      <Card ref={ref} className="mb-5 w-75 mx-auto">
        ...
        <Card.Body>
          ...
          <Card.Text className="p-3">
            ...
            <Link to={`/topic/${categoryTopic._id}`}>
        ...
        <Card.Footer className="d-flex justify-content-between justify-items-center ">
          ...
          <div>
            <p>
              <small> Started: {categoryTopic.author.published_date}</small>
            </p>
          </div>
        </Card.Footer>
      </Card>
